...
const UserDetailsCard = ({
    ...
    return (
        <div className="bg-slate-100/50 rounded-lg mt-16 overflow-hidden">
            <div className="w-full h-32 bg-profile-bg-img bg-cover flex justify-center bg-green-200 relative">
                <div className="absolute -bottom-10 rounded-full overflow-hidden border-2 border-green-500">
                    {profileImageUrl ? (
                        <img
                            src={profileImageUrl}
                            alt="Profile"
            ...
            <div className="mt-12 px-5">
                <div className="text-center pt-1">
                    <h5 className="text-lg text-green-600 font-medium leading-6">{fullName}</h5>
                    <span className="text-[13px] font-medium text-blue-500">@{username}</span>
                </div>
